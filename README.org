#+title: The =pseudotaxus-emacs= README
#+subtitle: A major mode for editing Pseudotaxus files in Emacs
#+date: <2022-06-13 Mon 17:54>
#+description: A major mode for editing Pseudotaxus files in Emacs
...
#+macro: summary A major mode for editing Pseudotaxus files in Emacs.
#+macro: installinfo (eval (cdr:readme-install-instructions "pseudotaxus-emacs" "emacs" "pseudotaxus"))
#+macro: useinfo (eval (cdr:readme-std-usage-instructions "pseudotaxus-emacs" "emacs" "pseudotaxus"))
#+macro: contribinfo (eval (cdr:readme-contrib-instructions "pseudotaxus-emacs"))
#+macro: licenseinfo (eval (cdr:readme-license-instructions "pseudotaxus-emacs" "agpl"))
** {{{TITLE}}}
